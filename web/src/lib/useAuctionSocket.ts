  ...
  switch (msg.type) {
    case 'STATE_SNAPSHOT': {
      ...
      return {
        ...
        currentNominatorTeamId: auction?.nominator_team_id ?? null,
    ...
    case 'NOMINATION_STARTED': {
      return {
        ...
        currentAuction: {
          ...
          position: state.currentAuction?.position ?? '',
          nfl_team: state.currentAuction?.nfl_team ?? '',
          tier: state.currentAuction?.tier ?? null,
          aav_minor: state.currentAuction?.aav_minor ?? 0,
          projected_points: state.currentAuction?.projected_points ?? null,
        },
